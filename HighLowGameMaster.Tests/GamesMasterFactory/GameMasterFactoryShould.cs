...
namespace HighLowGameMaster.Tests.GamesMasterFactory
{
    ...
    public sealed class GameMasterFactoryShould
    {
        ...
        {
            // Arrange
            var action = () => { new GameMasterFactory(new GameMasterSettings(minimumValue: -1, maximumValue: 1)); };
        ...
        {
            // Arrange
            var action = () => { new GameMasterFactory(new GameMasterSettings(minimumValue: 10, maximumValue: 5)); };
